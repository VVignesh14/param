...
@validator
def fi_business_id(business_id : str):
    """
...
@validator
def fi_ssn(ssn : str, allow_temporal_ssn : bool = True) -> bool:
    """
    ...
    """
    assert isinstance(ssn, str), "social security number 'ssn' must be a string"
    ...
    assert isinstance(allow_temporal_ssn, bool)
    return (
        int(gd['serial']) >= 2 and
