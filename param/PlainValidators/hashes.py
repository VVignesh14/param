...
def md5(value):
    ...
    """
    return md5_regex.match(value).group(0) == value
...
def sha1(value):
    ...
    """
    return sha1_regex.match(value).group(0) == value
...
def sha224(value):
    ...
    """
    return sha224_regex.match(value).group(0) == value
...
def sha256(value):
    ...
    """
    return sha256_regex.match(value).group(0) == value
...
def sha512(value):
    ...
    """
    return sha512_regex.match(value).group(0) == value
